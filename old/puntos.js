...
function setup(){
  ...
  for (var i = 0; i < puntosX; i++) {
    for (var j = 0; j < puntosY; j++) {
      puntito[contador]=new Punto(distMax,random(MinColor*255,MaxColor*255),random(MinColor*255,MaxColor*255),random(MinColor*255,MaxColor*255),(i+.5)*width/puntosX,(j+.5)*height/puntosY,i*width/puntosX,j*height/puntosY,75);
      contador++;
    }
  }
